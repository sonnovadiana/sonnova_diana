...
class Game:
    def __init__(self, player):
        ...
        """
        self.player = player
        self.__name_of_games = "'Угадай слово', 'Орел или решка"
    ...
    def pay(self):
        raise NotImplementedError('Это базовый класс и этот метод будет переодпределен в RandomWords, Coin')
    ...
    def __str__(self):
        return f"Имя игрока: {self.player}. Доступные игры: {self.__name_of_games}"
...
class RandomWords(Game):
    ...
    def words(self, value):
        raise AttributeError('Для добавления слов используйте метод add_words()')
